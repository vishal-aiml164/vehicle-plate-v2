...
def drawings(image,boxes_np,confidences_np,index):
    ...
    for ind in index:
        ...
        cv2.rectangle(image,(x,y),(x+w,y+h),(0,128,255),2)   #255,128,0 #original 255,0,255
        cv2.rectangle(image,(x,y-30),(x+w,y),(0,128,255),-1) #255,128,0 #original 255,0,255 BRR format (255,0,0) 
        cv2.rectangle(image,(x,y+h),(x+w,y+h+30),(0,0,0),-1) #255,128,0 #original 0,0,0


        cv2.putText(image,conf_text,(x,y-10),cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,255,255),1)  #255,128,0 #original 255,255,255
        cv2.putText(image,license_text,(x,y+h+27),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,128,255),1) #255,128,0 #original 0,255,0
